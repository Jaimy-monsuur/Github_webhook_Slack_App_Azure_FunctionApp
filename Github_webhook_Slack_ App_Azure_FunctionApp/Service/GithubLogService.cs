...
{
    public class GithubLogService : IGithubLogService
    {
        private readonly ILogger _logger;
        private readonly ILogRepo _logRepo;

        public GithubLogService(ILogRepo logRepo, ILoggerFactory loggerFactory)
        {
            _logger = loggerFactory.CreateLogger<GithubLogService>();
            _logRepo = logRepo;
        }
